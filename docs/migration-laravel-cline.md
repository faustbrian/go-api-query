...
6. Parse RPC parameters with `adapters/jsonrpc`, compile, and adapt only the plan.
...
shapes. Use generated code for execution and `adapters/postgres` only for reviewed
