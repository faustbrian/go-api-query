module github.com/faustbrian/go-api-query

go 1.26.5

require (
	github.com/faustbrian/go-jsonapi v0.0.0-20260715011545-30e710fd30d1
...
require (
	github.com/faustbrian/go-validation v0.0.0-20260716160325-238f8ef9a96a
...
replace github.com/faustbrian/go-validation => ../go-validation
